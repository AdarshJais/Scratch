...
import { SayBubble, ThinkBubble } from "./CatSprite";

export default function CatSpriteHistory({ id }) {
  return (
    <div id={id}>
      <svg
      ...
      <div style={{ position: "relative" }}>
        <SayBubble history={true} id={"say-bubble-history"} />
        <ThinkBubble history={true} id={"think-bubble-history"} />
      </div>
    </div>
  );
}
